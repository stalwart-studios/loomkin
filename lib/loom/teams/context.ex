defmodule Loom.Teams.Context do
  ...
  def broadcast_intent(team_id, agent_name, path, description) do
    Loom.Teams.Comms.broadcast(team_id, {:intent, agent_name, path, description})
  end
  ...
  defp team_table(team_id), do: Loom.Teams.TableRegistry.get_table!(team_id)
